...
pharms <- read.csv("Data_ByTG2.csv", header = TRUE)
...
fig1 <- ggplot(
  ...
  labs(
    title = "Top 10 Therapeutic Groups by Patients Who Received an Initial Dispensing of a Pharmaceutical",
...
fig2 <- ggplot(
  ...
  labs(
    title = "Trends in Patients Who Received an Initial Dispensing of a Top 10 TG2 Pharmaceutical",
    x = "Year",
    y = "Total Patients",
...
district_data <- read.csv("Data_ByTG2_Regional.csv", header = TRUE)
...
fig3 <- ggplot(
  ...
  labs(
    title = "Total Patients Who Received an Initial Dispensing of a Pharmaceutical by District",
    x = "District",
    y = "Total Patients (2021–2025)"
  ) +
  theme_minimal() +
...
fig4 <- ggplot(
  ...
  labs(
    title = "Top 10 TG2 Pharmaceuticals by District",
    x = "Therapeutic Group Level 2",
    y = "District",
    fill = "Total Patients"
  ) +
